...
- **Bomb** — built: starts at 2, capped at a max hold of 2 (a Calendar/
  Watch-to-Earn reward rolled while already full is simply not
  granted — Watch to Earn specifically falls back to gems instead so a
